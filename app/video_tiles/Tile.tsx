...
function Tile (props:Props) {
    ...
    return (
        <>
            ...
            <button type="button" onClick={props.onClick} className="rounded-lg grayscale w-full h-full block bg-cover" style={{ backgroundImage: `url(/images/ACaffery${props.imgNum}.webp)` }}>
